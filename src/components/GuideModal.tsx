      ...
      >
        ...
        <div className="space-y-2 pr-8">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-950/80 border border-cyan-500/40 text-cyan-300 text-xs font-mono font-bold tracking-wider uppercase">
            ...
            Official Flashing &amp; Installation Guide &gt;
          </div>
            ...
            <div className="space-y-3">
              ...
              <div className="pt-2 flex flex-wrap gap-3">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-white transition-colors text-xs font-bold cursor-pointer"
                >
                  Download ISO Image &gt;
                </button>
              </div>
